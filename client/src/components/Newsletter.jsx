...
const Newsletter = () => {
  return (
    <section className="h-full min-h-[400px] my-10 w-full bg-black flex flex-col lg:flex-row items-center py-6">
      <div className=' w-full max-w-[1300px] mx-auto px-3 gap-10 lg:gap-20 flex flex-col lg:flex-row items-center justify-evenly'>
        <div className='w-full'>
          <h1 className="text-[1.5rem] w-full md:text-[2rem] font-medium lg:max-w-[500px] leading-10 text-white">Get our emails for info on new items, sales and more.</h1>
